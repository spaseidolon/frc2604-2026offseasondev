...
public static class CtreV5Conversions extends Conversions {
   /**
* @param counts motor Counts
* @param gearRatio Gear Ratio between motor and Mechanism
* @return Degrees of Rotation of Mechanism
*/
public static double motorToDegrees(double motorPosition, double gearRatio) {
   double counts = 0;
...
//Phoenix 6 Conversions go here
public static class CtreV6Conversions extends Conversions {
   /**
* @param counts motor Counts
* @param gearRatio Gear Ratio between motor and Mechanism
* @return Degrees of Rotation of Mechanism
...
public static double RPMTomotor(double RPM, double gearRatio) {
   double motorRPM = RPM * gearRatio;
   double sensorCounts = motorRPM * (1 / 60);
   return sensorCounts;
}
